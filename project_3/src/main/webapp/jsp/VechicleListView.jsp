	...
	<div>
		<form class="pb-5" action="<%=ORSView.VECHICLE_LIST_CTL%>"
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="number" name="number" placeholder="Enter number" maxlength="200"
						class="form-control" 
				...
				<div class="col-sm-2">
					<input type="number" name="insuranceAmount" placeholder="Enter insuranceAmount"
				...
				<div class="col-sm-2">
					<input type="Date" name="purchaseDate"
						placeholder="Enter purchaseDate" class="form-control"

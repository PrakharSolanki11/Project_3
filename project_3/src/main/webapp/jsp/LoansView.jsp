...
<body class="hm">
	...
	<span class="pl-sm-5"><b>Interest_rate(%)</b>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text"  name= "intrestRate" class="form-control"  maxlength="4"   oninput=" validateVersion(event)" placeholder="intrestRate"  value="<%=DataUtility.getStringData(dto.getIntrestRate()).equals("0") ? ""
				: DataUtility.getStringData(dto.getIntrestRate())%>">
    </div>	
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("intrestRate", request)%></font></br>
